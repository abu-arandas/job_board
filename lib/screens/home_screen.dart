...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isLargeScreen = screenWidth >= 768; // Example breakpoint for larger screens
        ...
        child: Consumer<JobProvider>(
          builder: (context, jobProvider, child) {
            ...
            return SingleChildScrollView(
              padding: EdgeInsets.symmetric(horizontal: isLargeScreen ? 40 : 0), // Add horizontal padding for large screens
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                                    ...
                                    onPressed: () {
                                      showModalBottomSheet(
                                        ...
                                        builder: (context) => FilterBottomSheet(
                                          onApplyFilters:
                                              (jobType, experienceLevel, workLocation, minSalary, maxSalary) {
                  ...
                  if (jobProvider.featuredJobs.isNotEmpty) ...[
                    ...
                    const SizedBox(height: 16),
                    _buildFeaturedJobsList(jobProvider, isLargeScreen),
                  ...
                  // Recent jobs list
                  _buildRecentJobsList(jobProvider, isLargeScreen),
                ],
              ),
            );
          },
  ...
  Widget _buildFeaturedJobsList(JobProvider jobProvider, bool isLargeScreen) {
    if (isLargeScreen) {
      ...
      return SizedBox(
        height: 200, // Keep original height for mobile
  ...
  Widget _buildRecentJobsList(JobProvider jobProvider, bool isLargeScreen) {
    final recentJobs = jobProvider.jobs.take(isLargeScreen ? 6 : 5).toList(); // Show more items on large screen
    ...
    if (isLargeScreen) {
      ...
      return GridView.builder(
        ...
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          ...
          crossAxisSpacing: 16,
          mainAxisSpacing: 16,
          childAspectRatio: 2.5, // Adjust aspect ratio for JobCard
        ),
        ...
        children: [
          ...
          LayoutBuilder(builder: (context, constraints) {
            if (constraints.maxWidth > 600) {
              // Wider layout for premium insights
              return Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Add more stats if needed for wider screens
                        Row(
                          children: [
                            Expanded(
                              child: PremiumButton(
                                text: 'Resume Review AI',
                                icon: Icons.document_scanner_outlined,
                                onPressed: () => context.go('/resume-review'),
                                isOutlined: true,
                              ),
                            ),
                             const SizedBox(width: 12),
